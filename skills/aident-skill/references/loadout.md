...
| Check whether required accounts are connected in Aident Vault.                                                                                                       | `aident vault status --integrationIds composio:gmail_tools --json`                                                                                | Say "connected" only when Vault confirms it.                           |
